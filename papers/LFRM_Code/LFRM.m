% Code for implementing LFRM as described in Web Appendix B
...
% % set and predicted. To perform sequential predictions, change line 85 % %
% %                                                                      % %
% % Output files :                                                       % %
% % line 579 : plotting estimated trajectories                           % %
% % line 607 : computing predictive errors                               % %
% % line 632 : visualization of impact of covariates (boxplots)          % %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    for i = 1:nrun
      ...
      % -- Update of eta -- % 
        for h = 1:n
            ...
            etavar = (Lambda')*(x')*(invinner)*x*Lambda + eye(k);
...
save(strcat('Design'),'y', 'tij', 'ni', 'id', 'Bweight',  'n', 'O')
